...
const LandingPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
            ...
            <div className="xl:mx-[135px] lg:mx-[100px] md:mx-[60px] mx-[20px] py-4 lg:py-6 mb-10">
            ...
            <section className="py-8 lg:py-12 bg-gradient-to-br from-gray-50 to-white">
                <CategorySection
                    ...
                    category="trendig"
                    description="Discover our traditional snacks, made from original recipes passed down through generations."
                />
            </section>
